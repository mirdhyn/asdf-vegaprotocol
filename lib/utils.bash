...
# NOTE: You might want to remove this if vegaprotocol is not hosted on GitHub releases.
...
sort_versions() {
  sed 'h; s/[+-]/./g; s/.p\([[:digit:]]\)/.z\1/; s/$/.z/; G; s/\n/ /' |
    LC_ALL=C sort -t. -k 1,1 -k 2,2n -k 3,3n -k 4,4n -k 5,5n | awk '{print $2}' | tail -30
}
...
install_version() {
  ...
  (
    ...
    # TODO: Assert vegaprotocol executable exists.
    local tool_cmd
